...
import { DetallesProveedorComponent } from './gestor-logistico/detalles-proveedor/detalles-proveedor.component';
...
const routes: Routes = [

  {
    ...
    children:[
      ...
      {
        path: 'gestor-logistico/detalles-solicitud',
        component: DetallesSolicitudComponent, // Generar componente de Gestor Logistico ptm
        canActivate: [rolGuard],
        data: {
          idRol: 6,
        }
      ...
      {
        path: 'gestor-logistico/detalles-pedido',
        component: DetallespedidoComponent, // Generar componente de Gestor Logistico ptm
        canActivate: [rolGuard],
        data: {
          idRol: 6,
        }
      ...
      {
        path: 'gestor-logistico/pedidos/crear-pedido',
        component: CrearPedidoComponent, // Generar componente de Gestor Logistico ptm
        canActivate: [rolGuard],
        data: {
          idRol: 6,
        }
      ...
      {
        path: 'gestor-logistico/proveedores/detalles-proveedor',
        component: DetallesProveedorComponent, // Generar componente de Gestor Logistico ptm
        canActivate: [rolGuard],
        data: {
          idRol: 6,
        }
